...
export class PhotoDetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private photoService: PhotoService, private router: Router, private alertService: AlertService, private userService: UserService) { }
  ...
  remove() {
    this.photoService.removePhoto(this.id).subscribe(
      () => {
